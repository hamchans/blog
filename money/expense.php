        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <div id="contents">
                    ...
                    $date = $_POST['date'];
                    $amount = $_POST['amount'];
                    $category = $_POST['category_select_id'];
                    $account = $_POST['account_select_id'];
                    $store = $_POST['store_select_id'];
                    $memo = $_POST['memo'];
...
EOS;
                        ...
                        try{
                            ...
                            if ($dbh == null) {
                                ...
                                $sql = 'INSERT INTO expense(date, amount, expense_category, account, store, memo) VALUES(?, ?, ?, ?, ?, ?)';
                                $stmt = $dbh->prepare($sql);
                                $stmt->execute(array($year.'-'.$month.'-'.$date, $amount, $category, $account, $store, $memo));
