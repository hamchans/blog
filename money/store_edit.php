...
EOS;
                                print<<<EOS
                                <section id="add">
                                    <form method="post" action="store_edit_add_check.php">
                                        <h7>カテゴリ名</h7>
                                        <br>
                                        <input type="text" name="store_add_name">
                                        <br>
...
EOS;
                                print<<<EOS
                                <section id="edit">
                                    <form method="post" action="store_edit_edit_check.php">

                                        <h7>カテゴリ名</h7>
                                        <br>
                                        <select name="store_edit_id">
EOS;
...
EOS;
                                        ...
                                        <br>
                                        <input type="text" name="store_edit_name">
                                        <br>
...
EOS;
                                print<<<EOS
                                <section id="delete">
                                    <form method="post" action="store_edit_delete_check.php">

                                    <h7>カテゴリ名</h7>
                                    <br>
                                    <select name="store_delete_id">
EOS;
                                        $sql = 'SELECT * FROM store WHERE userId = ?';
                                        $stmt = $dbh->prepare($sql);
                                        $stmt->execute(array($_SESSION['userId']));
