        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <div id="contents">
                    ...
                    $account_edit_id = $_POST['account_edit_id'];
                    $account_edit_name = $_POST['account_edit_name'];
...
EOS;
                        ...
                        try{
                            ...
                            if ($dbh == null) {
                                ...
                                $stmt->execute(array($account_edit_name, $account_edit_id));
                                
                                print<<<EOS
                                編集しました．<br>
                                <a href="account_edit.php">カテゴリー設定画面へ戻る</a>
