        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <div id="contents">
                    ...
                    $category_edit_name = $_POST['category_edit_name'];
                    $sort = $_POST['sort'];
...
EOS;
                        ...
                        try{
                            ...
                            if ($dbh == null) {
                                ...
                                $sql = 'UPDATE expense_category SET name = ? WHERE id = ?';
                                $stmt = $dbh->prepare($sql);
                                $stmt->execute(array($category_edit_name, $category_edit_id));
                                
                                print<<<EOS
                                編集しました．<br>
                                <a href="category_edit.php">設定画面へ</a>
