        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <div id="contents">
                    ...
                    $date = $_POST['date'];
                    $amount = $_POST['amount'];
                    $source_account = $_POST['source_account_id'];
                    $destination_account = $_POST['destination_account_id'];
                    $memo = $_POST['memo'];
...
EOS;
                        ...
                        try{
                            ...
                            if ($dbh == null) {
                                ...
                                $sql = 'INSERT INTO transfer(date, src_amount, dst_amount, source_account, destination_account, memo) VALUES(?, ?, ?, ?, ?, ?)';
                                $stmt = $dbh->prepare($sql);
                                $stmt->execute(array($year.'-'.$month.'-'.$date, $amount, $amount, $source_account, $destination_account, $memo));
                                
                                
                                print<<<EOS
                                追加しました．<br>
                                <a href="operation.php">操作画面へ戻る</a>
