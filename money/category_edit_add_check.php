        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <div id="contents">
                    ...
                    $category_add_name = $_POST['category_add_name'];
                    $sort = $_POST['sort'];
...
EOS;
                        ...
                        try{
                            ...
                            if ($dbh == null) {
                                ...
                                if ($sort == 1) {
                                    $sql = 'INSERT INTO expense_category(userId, name) VALUES(?, ?)';
                                    $stmt = $dbh->prepare($sql);
                                    $stmt->execute(array($_SESSION['userId'], $category_add_name));
                                } else {
                                    $sql = 'INSERT INTO income_category(userId, name) VALUES(?, ?)';
                                    $stmt = $dbh->prepare($sql);
                                    $stmt->execute(array($_SESSION['userId'], $category_add_name));
                                }
                                ...
                                print<<<EOS
                                追加しました．<br>
                                <a href="category_edit.php">カテゴリー設定画面へ戻る</a>
