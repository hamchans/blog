...
EOS;
                            ...
                            print<<<EOS
                            <section id="add">
                                <form method="post" action="genre_add_check.php">
                                    <h7>ジャンル名</h7>
                                    <br>
...
EOS;
                            print<<<EOS
                            <section id="edit">
                                <form method="post" action="genre_edit_check.php">

                                    <h7>ジャンル名</h7>
                                    <br>
                                    <select name="genre_edit_id">
EOS;
                                        $sql = 'SELECT * FROM genre WHERE userId = ?';
...
EOS;
                            print<<<EOS
                            <section id="delete">
                                <form method="post" action="genre_delete_check.php">

                                    <h7>カテゴリ名</h7>
                                    <br>
                                    <select name="genre_delete_id">
EOS;
                                        $sql = 'SELECT * FROM genre WHERE userId = ?';
                                        $stmt = $dbh->prepare($sql);
                                        $stmt->execute(array($_SESSION['userId']));
